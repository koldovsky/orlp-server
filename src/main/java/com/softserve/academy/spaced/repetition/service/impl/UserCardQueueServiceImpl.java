...
public class UserCardQueueServiceImpl implements UserCardQueueService {
    ...
    @Autowired
    public UserCardQueueServiceImpl(UserCardQueueRepository userCardQueueRepository, UserServiceImpl userService, RememberingLevelRepository rememberingLevelRepository) {
