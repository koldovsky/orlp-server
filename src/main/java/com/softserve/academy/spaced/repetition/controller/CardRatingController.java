...
import com.softserve.academy.spaced.repetition.controller.utils.dto.impl.CardRatingPublicDTO;
...
public class CardRatingController {
    ...
    public ResponseEntity<CardRatingPublicDTO> addCardRating(@Validated(Request.class)
                                                                 @RequestBody CardRating cardRating,
