...
public class AuthenticationRestService {
    ...
    public HttpHeaders getHeadersForRefreshToken(HttpServletRequest request) {
        ...
        if (jwtTokenUtil.canTokenBeRefreshed(token, user.getLastPasswordResetDate())) {
            ...
            throw new BadCredentialsException(messageSource.getMessage("exception.message.notvalid.token", new Object[]{}, locale));
        }
    }
    ...
    private String getTokenFromRequest(HttpServletRequest request) {
        ...
        if (token != null) {
            ...
            throw new BadCredentialsException(messageSource.getMessage("exception.message.no.token", new Object[]{}, locale));
        }
    }
    ...
    private void validateUser(UserDetails userDetails){
        if(!userDetails.isAccountNonLocked()){
            throw new LockedException(messageSource.getMessage("exception.message.deactivated.account", new Object[]{}, locale));
        }
    }
}
