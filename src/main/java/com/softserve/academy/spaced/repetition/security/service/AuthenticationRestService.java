...
public class AuthenticationRestService {
    ...
    public HttpHeaders getHeadersForRefreshToken(HttpServletRequest request) {
        ...
        if (jwtTokenUtil.canTokenBeRefreshed(token, user.getLastPasswordResetDate())) {
            ...
            throw new BadCredentialsException(messageSource.getMessage("exception.message.notValidToken", new Object[]{}, locale));
        }
    }
    ...
    private String getTokenFromRequest(HttpServletRequest request) {
        ...
        if (token != null) {
            ...
            throw new BadCredentialsException(messageSource.getMessage("exception.message.noToken", new Object[]{}, locale));
        }
    }
    ...
    private void validateUser(UserDetails userDetails){
        if(!userDetails.isAccountNonLocked()){
            throw new LockedException(messageSource.getMessage("exception.message.deactivatedAccount", new Object[]{}, locale));
        }
    }
}
