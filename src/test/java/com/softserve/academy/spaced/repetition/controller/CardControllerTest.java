...
public class CardControllerTest {
    ...
    public static List<Card> createLearningCards(long deckId) {
        ...
        Deck deck = new Deck();
        deck.setId(deckId);
        Card card = DomainFactory.createCard(1L, "Card 1", "How many access modifiers do you know in Java?",
                "There are 4 access modifiers in Java: public, protected, default and private", deck);
        Card card2 = DomainFactory.createCard(2L, "Card 2", "What are the supported platforms by Java Programming" +
        ...
        Card card3 = DomainFactory.createCard(3L, "Card 3", "List any five features of Java?", "Some " +
                "features include Object Oriented, Platform Independent, Robust, Interpreted, Multi-threaded", deck);
        Card card4 = DomainFactory.createCard(4L, "Card 4", "Why is Java Architectural Neutral?",
                ...
                deck);
        Card card5 = DomainFactory.createCard(5L, "Card 5", "How Java enabled High Performance?", "Java " +
        ...
        Card card6 = DomainFactory.createCard(6L, "Card 6", "Why Java is considered dynamic?", "It is " +
        ...
        Card card7 = DomainFactory.createCard(7L, "Card 7", "What is Java Virtual Machine and how it is considered" +
                ...
                "being run.", deck);
        Card card8 = DomainFactory.createCard(8L, "Card 8", "List two Java IDE’s?", "Netbeans, Eclipse, etc."
                , deck);
        Card card9 = DomainFactory.createCard(9L, "Card 9", "List some Java keywords(unlike C, C++ keywords)?",
                "Some Java keywords are import, super, finally, etc.", deck);
        Card card10 = DomainFactory.createCard(10L, "Card 10", "What do you mean by Object?", "Object is a" +
    ...
    public void getCardById() throws Exception {
        when(cardService.getCard(eq(1L))).thenReturn(createCard(RATING,DECK_ID));
    ...
    public void getLearningCards() throws Exception {
        ...
        when(cardService.getLearningCards(deckId)).thenReturn(createLearningCards(DECK_ID));
